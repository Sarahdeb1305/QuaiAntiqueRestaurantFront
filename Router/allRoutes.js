...
export const allRoutes = [
    ...
    new Route("/maReservation", "Mon récapitulatif de réservation", "/pages/reservation/maReservation.html"),
    new Route("/merci", "Merci pour votre réservation", "/pages/reservation/merci.html"),
];
